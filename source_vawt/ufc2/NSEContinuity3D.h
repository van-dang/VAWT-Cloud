...
typedef CoefficientSpace_beta Form_1_FunctionSpace_9;
...
public:
  ...
  Form_1(const dolfin::FunctionSpace& V0):
    dolfin::Form(1, 9), u(*this, 0), p(*this, 1), h(*this, 2), k(*this, 3), c1(*this, 4), u0(*this, 5), p0(*this, 6), hmin(*this, 7), beta(*this, 8)
  {
    _function_spaces[0] = reference_to_no_delete_pointer(V0);
  ...
  typedef Form_1_FunctionSpace_9 CoefficientSpace_beta;
...
public:
  ...
  NSEContinuity3DLinearForm(dolfin::Function& w0, dolfin::Function& w1, dolfin::Function& w2, dolfin::Function& w3, dolfin::Function& w4, dolfin::Function& w5, dolfin::Function& w6, dolfin::Function& w7, dolfin::Function& w8) : dolfin::Form()
  {
    __coefficients.push_back(&w0);
    __coefficients.push_back(&w1);
    __coefficients.push_back(&w2);
